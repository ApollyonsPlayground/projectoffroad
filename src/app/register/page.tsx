    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-5">
      <div className="w-full max-w-sm flex flex-col gap-8">
        ...
        <div className="text-center">
          ...
          <p className="text-zinc-500 text-[14px]">Create your community account</p>
        </div>
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-3 py-5 rounded-2xl border-2 border-orange-500 bg-black text-white font-bold text-[17px] hover:bg-orange-500/8 transition-colors shadow-lg shadow-orange-500/20"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[12px] text-zinc-600 font-medium">or create with email</span>
          <div className="flex-1 h-px bg-zinc-800" />
        </div>
