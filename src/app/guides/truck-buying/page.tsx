    ...
    <main className="min-h-screen bg-stone-950">
      ...
      <header className="py-12 px-4 bg-stone-900 border-b border-stone-800">
        <div className="container mx-auto max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-stone-50 mb-4">
            Truck <span className="italic text-primary">Buying Guide</span>
          </h1>
      ...
      <article className="py-12 px-4">
        <div className="container mx-auto max-w-4xl prose prose-invert prose-orange max-w-none">
          ...
          {/* Recommendation */}
          <section className="bg-stone-900/50 rounded-2xl border border-primary/30 p-8 mb-8">
            ...
            <p className="text-stone-300 text-lg">
              ...
              <span className="text-primary/90 font-bold"> mid-size truck</span> (Toyota Tacoma / Ford Ranger / Chevy Colorado) or 
              <span className="text-primary/90 font-bold"> Jeep Wrangler</span> if rock-focused.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-stone-900/50 rounded-xl border border-stone-700 p-6">
                ...
                <p className="text-stone-400 mb-3"><span className="font-semibold text-primary/90">Models:</span> Toyota Tacoma, Ford Ranger, Chevy Colorado, Nissan Frontier</p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-primary/90 font-semibold mb-1">Best for:</p>
              ...
              <div className="bg-stone-900/50 rounded-xl border border-stone-700 p-6">
                ...
                <p className="text-stone-400 mb-3"><span className="font-semibold text-primary/90">Models:</span> Wrangler 2-door, 4-door Unlimited, Gladiator</p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-green-400 font-semibold mb-1">Pros:</p>
              ...
              <div className="bg-stone-900/50 rounded-xl border border-stone-700 p-6">
                ...
                <p className="text-stone-400 mb-3"><span className="font-semibold text-primary/90">Models:</span> Ford F-150, Toyota Tundra, Chevy Silverado, Ram 1500</p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-green-400 font-semibold mb-1">Pros:</p>
              ...
              <div className="bg-stone-900/50 rounded-xl border border-stone-700 p-6">
                ...
                <p className="text-stone-400 mb-3"><span className="font-semibold text-primary/90">Models:</span> Toyota 4Runner, Subaru Outback, Ford Explorer, Lexus GX</p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-green-400 font-semibold mb-1">Pros:</p>
          ...
          <section className="mb-8">
            ...
            <div className="bg-stone-900/50 rounded-xl border border-stone-700 p-6">
              <ul className="space-y-3 text-stone-300">
                <li>• <span className="text-primary/90 font-semibold">Ground clearance</span> — More = less risk of hitting skid-sensitive parts</li>
                <li>• <span className="text-primary/90 font-semibold">Approach/Departure/Breakover angles</span> — Determines how well you handle steep transitions</li>
                <li>• <span className="text-primary/90 font-semibold">4L (Low Range)</span> — Essential for slow technical sections</li>
                <li>• <span className="text-primary/90 font-semibold">Locking differentials</span> — Drastically improve capability on uneven terrain</li>
                <li>• <span className="text-primary/90 font-semibold">Tire fit</span> — Room for larger tires without rubbing</li>
                <li>• <span className="text-primary/90 font-semibold">Payload & towing</span> — Important for heavy camping gear or trailers</li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-stone-900/50 rounded-xl border border-primary/30 p-6">
                <h3 className="font-bold text-primary/90 text-lg mb-3">Buy Used If...</h3>
                <ul className="space-y-2 text-stone-300 text-sm">
