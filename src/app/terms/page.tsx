    ...
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-invert prose-amber">
          ...
          <h2 className="text-foreground mt-8">2. Platform Nature</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">3. Assumption of Risk</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">4. Liability Disclaimer & Limitation of Liability</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">5. Indemnification</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">6. User Accounts</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">7. User Content</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">8. Content Moderation</h2>
          ...
          <h2 className="text-foreground mt-8">9. Prohibited Activities</h2>
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mt-2">
          ...
          <h2 className="text-foreground mt-8">10. DMCA & Copyright Policy</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">11. Dispute Resolution & Arbitration</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">12. Governing Law</h2>
          <p className="text-gray-300">
            These Terms shall be governed by and construed in accordance with the laws of the State of California, without regard to its conflict of law provisions.
          </p>

          <h2 className="text-foreground mt-8">13. Force Majeure</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">14. Modifications</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">15. Termination</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">16. Severability</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">17. Entire Agreement</h2>
          <p className="text-gray-300">
          ...
          <h2 className="text-foreground mt-8">18. Contact Information</h2>
