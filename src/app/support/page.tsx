    ...
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-invert prose-amber">
          <h2 className="text-foreground mt-8">Contact</h2>
          ...
          <h2 className="text-foreground mt-8">Quick links</h2>
          ...
          <h2 className="text-foreground mt-8">Common issues</h2>
          <h3 className="text-foreground mt-6">Google sign-in loops or won’t finish</h3>
          <p className="text-gray-300">
          ...
          <h3 className="text-foreground mt-6">I can’t see photos in the feed</h3>
          <p className="text-gray-300">
          ...
          <h3 className="text-foreground mt-6">Report content or safety concerns</h3>
          <p className="text-gray-300">
