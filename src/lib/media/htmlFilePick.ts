type HtmlFilePickOptions = {
  accept: string;
  /** Opens camera capture on mobile when set. Omit for photo library. */
  capture?: 'user' | 'environment';
};

/**
 * WKWebView file picker — works when Capacitor Camera native bridge is missing.
 * Returns null when the user dismisses the picker without choosing a file.
 */
