      ...
      >
        ...
        <div className="p-2">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left text-foreground hover:bg-background/60 transition-colors touch-manipulation"
          >
          ...
          <button
            type="button"
            onClick={() => choose('cancel')}
            className="w-full mt-1 px-4 py-3.5 rounded-xl text-center text-[15px] font-semibold text-muted-foreground hover:bg-background/60 transition-colors touch-manipulation"
          >
            Cancel
          </button>
        </div>
