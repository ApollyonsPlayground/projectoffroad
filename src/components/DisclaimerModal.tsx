...
export default function DisclaimerModal() {
  ...
  const ui = (
    <div
      role="presentation"
      className="fixed inset-0 left-0 top-0 right-0 bottom-0 z-[20000] flex items-center justify-center bg-black/95 p-5 text-left"
      style={{
        width: '100%',
        minHeight: '100dvh',
        ...
        <div className="px-5 py-5 space-y-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed">
              The site owner is <span className="text-zinc-200 font-semibold">not responsible</span> for
              cancellations or trail condition changes. Safety rests solely with each run organizer.
            </p>
          </div>

          <p className="text-zinc-400 text-xs leading-relaxed">
            By continuing you <span className="text-zinc-200 font-semibold">assume all risk</span> and hold
